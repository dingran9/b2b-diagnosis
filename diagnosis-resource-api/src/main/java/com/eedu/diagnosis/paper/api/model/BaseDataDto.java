package com.eedu.diagnosis.paper.api.model;
...
public class BaseDataDto  implements Serializable{
	...
	public String getIsnewDate() {
		return isnewDate;
	}
	public void setIsnewDate(String isnewDate) {
	...
	private  List<BaseDataDto> knowledgeList;


	public List<BaseDataDto> getKnowledgeList() {
		return knowledgeList;
	}
	public void setKnowledgeList(List<BaseDataDto> knowledgeList) {
