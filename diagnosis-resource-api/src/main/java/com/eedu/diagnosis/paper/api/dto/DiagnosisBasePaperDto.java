 ...
 * 
 **/
public class DiagnosisBasePaperDto implements Serializable{
    ...
    private List<DiagnosisBigQuestionDto> diagnosisBigQuestionDtosList;
	...
	public List<DiagnosisBigQuestionDto> getDiagnosisBigQuestionDtosList() {
		return diagnosisBigQuestionDtosList;
	}

	public void setDiagnosisBigQuestionDtosList(
			List<DiagnosisBigQuestionDto> diagnosisBigQuestionDtosList) {
		this.diagnosisBigQuestionDtosList = diagnosisBigQuestionDtosList;
	}
