//package com.eeduspace.report.mqconsumer;
//
...
//    @Autowired
//    private B2BReportOpenServiceImpl b2BReportOpenService;
//    /**
...
//                                b2BReportOpenService.generateTeacherOrPrincipalReport(body, ReportCategoryEnum.TEACHER_REPORT);
//                            } catch (Exception e) {
//                                logger.info(" Topic:<diagnosis-system-manager> Tag:<make-report> consume message error :" + e.getMessage());
//                            }
//                        }
//                        break;
