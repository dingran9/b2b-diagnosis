...
public class DiagnosisInClassTestModel extends BaseModel {
    ...
    private List<DiagnosisInClassRelationModel> list;
    ...
    public List<DiagnosisInClassRelationModel> getList() {
        return list;
    }

    public void setList(List<DiagnosisInClassRelationModel> list) {
        this.list = list;
    }
