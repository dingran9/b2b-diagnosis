...
public class PoiUtils {
     ...
     * @param out 输出流
     */
    public static void exportExcelX(String title,String[] property,String[] header, JSONArray jsonArray, String datePattern, int colWidth, OutputStream out) {
        ...
        int[] arrColWidth = new int[property.length];
        // 产生表格标题行,以及设置列宽
    ...
    //Web 导出excel
    public static void downloadExcelFile(String title,String[] property,String[] header,JSONArray ja,HttpServletResponse response){
        try {
            ByteArrayOutputStream os = new ByteArrayOutputStream();
            PoiUtils.exportExcelX(title,property,header,ja,null,0,os);
